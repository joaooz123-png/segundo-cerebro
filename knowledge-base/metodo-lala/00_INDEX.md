...
1. [Núcleo canônico](01_NUCLEO_CANONICO.md)
2. [Arquitetura científica e operacional](02_ARQUITETURA_METODO.md)
3. [Princípios do Caderno de Taís](05_CADERNO_TAIS_PRINCIPIOS.md)
...
Toda informação nova deve ser marcada como:
...
A versão canônica deve conter apenas o que permanece válido após as correções mais recentes. Fatos, relatos, hipóteses, pendências, conflitos e versões substituídas devem permanecer distinguíveis.